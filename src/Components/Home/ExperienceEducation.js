  ...
  return (
    ...
    >
      <div className="[@media(min-width:1290px)]:w-[1290px] w-[100%] mx-auto py-[5rem] relative border-x-[1px] border-dashed border-x-[#00000038] [@media(min-width:1290px)]:!px-[3rem] [@media(min-width:550px)]:px-[2rem] [@media(min-width:450px)]:px-[1.5rem] px-[1rem]">
        ...
        {/* Tittle */}
        <div className="[@media(min-width:600px)]:!w-[27rem] [@media(min-width:460px)]:w-[20.5rem] [@media(min-width:400px)]:w-[17.9rem] w-[11rem] [@media(min-width:600px)]:h-[20px] [@media(min-width:400px)]:h-[16px] h-[41px] text-[#130f49] text-center flex items-center justify-center z-10 [@media(min-width:400px)]:mb-[5rem] mb-[3.5rem] mx-auto relative">
          <h1 className="[@media(min-width:600px)]:text-[28px] [@media(min-width:460px)]:text-[22px] text-[19px] font-[700] Poppins uppercase">
            Experience <br className="[@media(min-width:400px)]:hidden flex "/>& Education
          </h1>
