...
function HomeBanner() {
  ...
  return (
    <div className="w-full h-full pt-[75px] relative mb-[10rem]" name="Home">
      <Navber />
      ...
      <div className="absolute left-[-170px] top-0 w-full flex justify-center z-[0]">
        <div className="[@media(min-width:1536px)]:w-[1536px] w-full mx-auto flex justify-start">
          <img
            src={partical_1}
            className="[@media(min-width:660px)]:!w-[170px] [@media(min-width:460px)]:w-[140px] w-[120px] scale-x-[-1]"
          />
        </div>
      </div>
      ...
      <div className="w-full h-full [@media(min-width:1290px)]:!px-0 [@media(min-width:550px)]:px-[2rem] [@media(min-width:450px)]:px-[1.5rem] px-[1rem] border-b-[1px] border-b-[#00000038] border-dashed">
        <div className="[@media(min-width:1290px)]:w-[1290px] w-[100%] h-full [@media(min-width:920px)]:py-[4rem] py-0  flex [@media(min-width:920px)]:flex-row flex-col justify-between items-center mx-auto  relative border-x-[1px] border-dashed border-x-[#00000038] [@media(min-width:1290px)]:!px-[3rem] [@media(min-width:550px)]:px-[2rem] [@media(min-width:450px)]:px-[1.5rem] px-[1rem]">
          ...
          <div
            className="[@media(min-width:920px)]:w-[60%] [@media(min-width:768px)]:w-[90%] w-[100%] z-10 GeologicaFont text-[#55527c] relative [@media(min-width:920px)]:text-left text-center [@media(min-width:920px)]:pt-0 pt-[35px]"
          >
            <h1
              className="text-[55px] leading-[55px] font-[700] [@media(min-width:920px)]:mx-[] mx-auto text-[#130f49] ml-[-5px] [@media(min-width:640px)]:pb-[11px] pb-[8px]"
            >
              Hi, I'm Atik!
            </h1>
            <h1
              className="text-[55px] leading-[55px] font-[700] [@media(min-width:920px)]:mx-[] mx-auto text-[#130f49] ml-[-5px] pb-[15px]"
            >
              Creative
            ...
            <p className="[@media(min-width:1060px)]:w-[589px] [@media(min-width:640px)]:w-[500px] w-[98%] [@media(min-width:1160px)]:text-[16px] [@media(min-width:360px)]:text-[15px] text-[13px] [@media(min-width:920px)]:mx-0 mx-auto [@media(min-width:360px)]:leading-[25px] leading-[20px] KarlaFont">
              I'm a Bangladesh based web designer & front‑end developer focused on crafting clean & user‑friendly experiences, I am passionate about building excellent software that improves the lives of those around me.
            </p>
            <div className="flex [@media(min-width:920px)]:justify-start justify-center items-center pt-[20px] [@media(min-width:920px)]:mx-0 mx-auto">
              <button
                className="[@media(min-width:530px)]:text-[15px] [@media(min-width:360px)]:text-[13px] text-[11px] [@media(min-width:530px)]:px-[25px] [@media(min-width:360px)]:px-[23px] px-[12px] py-[8px] border-[2px] rounded-[10px] border-[#130f49] bg-[#130f49] text-[#fff] social_icon_hover transition-[0.3s] cursor-pointer"
              >
                Got a Project?
              </button>
              <button
                className="[@media(min-width:530px)]:text-[15px] [@media(min-width:360px)]:text-[13px] text-[11px] [@media(min-width:530px)]:px-[25px] [@media(min-width:360px)]:px-[23px] px-[12px] py-[8px] border-[2px] rounded-[10px] border-[#130f49]  text-[#130f49] social_icon_hover transition-[0.3s] cursor-pointer ml-[0.8rem]"
              >
                Let's Talk
              </button>
            </div>
