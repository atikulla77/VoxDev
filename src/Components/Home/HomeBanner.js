    ...
    <div className="w-full h-full pt-[75px] relative mb-[10rem]" name="Home">
      ...
      <div className="w-full h-full [@media(min-width:1290px)]:!px-0 [@media(min-width:550px)]:px-[2rem] [@media(min-width:450px)]:px-[1.5rem] px-[1rem] border-b-[1px] border-b-[#00000038] border-dashed">
        <div className="[@media(min-width:1290px)]:w-[1290px] w-[100%] h-full [@media(min-width:920px)]:py-[4rem] py-0  flex [@media(min-width:920px)]:flex-row flex-col justify-between items-center mx-auto  relative border-x-[1px] border-dashed border-x-[#00000038] [@media(min-width:1290px)]:!px-[3rem] [@media(min-width:550px)]:px-[2rem] [@media(min-width:450px)]:px-[1.5rem] px-[1rem]">
          ...
          <div
            className="[@media(min-width:920px)]:w-[60%] [@media(min-width:768px)]:w-[90%] w-[100%] z-10 GeologicaFont text-[#55527c] relative [@media(min-width:920px)]:text-left text-center [@media(min-width:920px)]:pt-0 pt-[35px] [@media(min-width:920px)]:pb-0 pb-[3rem]"
          >
            <h1
            ...
            <div className="flex [@media(min-width:920px)]:justify-start justify-center items-center pt-[20px] [@media(min-width:920px)]:mx-0 mx-auto">
              <button
                className="[@media(min-width:920px)]:!text-[13px] [@media(min-width:500px)]:text-[11px] text-[10px] [@media(min-width:920px)]:!px-[25px] px-[23px] py-[8px] border-[2px] rounded-[10px] border-[#130f49] bg-[#130f49] text-[#fff] social_icon_hover transition-[0.3s] cursor-pointer"
              >
                Got a Project?
              </button>
              <button
                className="[@media(min-width:920px)]:!text-[13px] [@media(min-width:500px)]:text-[11px] text-[10px] [@media(min-width:920px)]:!px-[25px] px-[23px] py-[8px] border-[2px] rounded-[10px] border-[#130f49]  text-[#130f49] social_icon_hover transition-[0.3s] cursor-pointer ml-[0.8rem]"
              >
                Let's Talk
              </button>
            </div>
